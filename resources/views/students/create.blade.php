...
<main class="bg-white max-w-lg mx-auto p-8 my-10 rounded-lg shadow-2xl">
   ...
   <section class="mt-10">
      <form action="/add/student" method="POST" class="flex flex-col">
         ...
         <button type="submit" class="bg-gray-600 hover:bg-gray-400 text-white font-bold py-2 rounded shadow-lg hover:shadow-xl transitionduration-200" type="submit">Add New</button>
      </form>
   </section>
</main>
